...
#to be more specific about what you'll be adding to the dataset, instead of all 100
#anti_data <- anti_join(new_data, tail(all_health_breaches,100))
#all.equal(new_data, anti_data)
...
dateRangeInput("select_Dates", label = h6("Pick a date range"))
