...
radioButtons("variable_choice2", 
            ...
            choices = list("incidents (Hacking/IT Incident, Theft, Unauthorized Access/Disclosure, Loss, Improper Disposal)" = "incident", "type of target entities (Healthcare Provider, Business Associate, Health Plan, Healthcare Clearing House)" = "type", "digital location of attacks (Network Server, Email, Paper/Films, Other Portable Electronic Device, Desktop Computer, Electronic Medical Record, Laptop)" = "location"), selected = "incident")
...
Below, a general [ANOVA test](https://www.qualtrics.com/experience-management/research/anova/) is run to demonstrate that all these variables have an impact on the number of affected individuals for a given cyberattack, with **p<0.01** for every category, as emphasized by the number of asteriks following the Pr(>F) values. 

```{r}

print(summary(aov(affected_transformed ~ incident + type + location, 
            data = all_health_breaches_transformed)))
...
Dealing with Data {data-icon="fa-magnifying-glass"}
===================================== 
