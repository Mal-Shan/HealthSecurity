...
### Hover over the map to see the TOTAL number of individuals affected by CyberSecurity attacks in each state
...
### Hover over the map to see the PER CAPITA number of individuals affected by CyberSecurity attacks in each state
...
### View Table of TOTAL and PER CAPITA number of individuals affected by CyberSecurity attacks in each state
    
```{r}

state_attack_summary <- reactive({ 
    sum_merged_cyber_pc %>%
...
renderDT({
    datatable(state_attack_summary(), 
              rownames = FALSE,
...
### View Table of ALL CyberSecurity attacks (including entity, location of attack, date affected, number affected, etc.)
