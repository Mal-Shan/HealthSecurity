...
Explore Map of Attacks {.storyboard}
=====================================

### Explore the TOTAL number of individuals affected by CyberSecurity attacks across each state
...
### Explore the PER CAPITA number of individuals affected by CyberSecurity attacks across each state
```{r}
...
View Attack History {data-icon="fa-table"}
===================================== 
